...
export function setItexpayApiKeys(session: SessionContextProps, itexkeys: ItexpayProps) {

    db.setItexpay(session, itexkeys);

    return true;
}

export async function getItexpayApiKeys(session: SessionContextProps) {
    return await db.getItexpay(session);
}

// export function setItexpayTrans(session: SessionContextProps, itextransaction: ItexpayTransactionsProps) {
//
//     db.setItexpayTransaction(session, itextransaction);
//
//     return true;
// }

// export async function getItexpayTrans(session: SessionContextProps) {
//     return await db.getItexpayTransactions(session);
// }
